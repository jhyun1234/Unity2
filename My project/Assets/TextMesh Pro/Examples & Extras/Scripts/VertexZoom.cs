    ...
    public class VertexZoom : MonoBehaviour
    {
        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                {
                    UnityEngine.Vector2[] uv2Array = new UnityEngine.Vector2[textInfo.meshInfo[i].uvs0.Length];
                    for (int j = 0; j < textInfo.meshInfo[i].uvs0.Length; j++)
                    {
                        uv2Array[j] = new UnityEngine.Vector2(textInfo.meshInfo[i].uvs0[j].x, textInfo.meshInfo[i].uvs0[j].y);
                    }
                    textInfo.meshInfo[i].mesh.uv = uv2Array;
